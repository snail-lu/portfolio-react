...
const About = () => {
    return (
        <div className={styles.about_me_container}>
            <a
                className={`${styles.about_item} flex-box flex-box-v-center flex-box-h-center`}
                href="https://github.com/snail-lu"
                target="_blank"
            ...
            <a
                className={`${styles.about_item} flex-box flex-box-v-center flex-box-h-center`}
                href="https://www.cnblogs.com/snaillu/"
                target="_blank"
                rel="noopener noreferrer"
                title="博客"
            >
            ...
            <a
                className={`${styles.about_item} flex-box flex-box-v-center flex-box-h-center`}
                href="mailto:snaillu@yeah.net"
                target="_blank"
                rel="noopener noreferrer"
                title="snaillu@yeah.net"
            >
