...
const TopNav = ({ show, switchClick }) => {
  return (
    <div className={styles.topNavContainer}>
      <div
        className={`${styles.menu_bar} ${show ? styles.active : ''}`}
        onClick={() => switchClick(show ? HIDE_NAV : SHOW_NAV)}
      >
        {show ? (
          <div className={styles.menu_list}>
            ...
            <NavLink to="/projects" className={styles.menu_item} onClick={(e) => e.stopPropagation()}>
              PROJECT
            </NavLink>
            <NavLink to="/demo" className={styles.menu_item} onClick={(e) => e.stopPropagation()}>
              DEMO
            </NavLink>
            <NavLink to="/about" className={styles.menu_item} onClick={(e) => e.stopPropagation()}>
              ABOUT
            </NavLink>
          </div>
        ) : (
